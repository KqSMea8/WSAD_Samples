...
/**
 * This demonstrates how to obtain the TimeSheetProperties
 */
public class TimeSheetProperties implements PropertyCapable {
/**
 * TimeSheetProperties constructor comment.
 */
public TimeSheetProperties() {
	super();
	initialize();
}
/**
...
public void initialize() {
	...
	String path = platformFilePath()+"wsbook.properties";
...
private String platformFilePath() {
	...
	return drive+separator+"wsbook"+separator;
}	
