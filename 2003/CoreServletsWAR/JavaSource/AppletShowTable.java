 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class AppletShowTable extends JApplet implements ActionListener {

	private javax.swing.JPanel jContentPane = null;

	private javax.swing.JTable jTable = null;
	private javax.swing.JScrollPane jScrollPane = null;
	private AppletShowQueryCollection currentQueries = null;
	private String address =
		"/CoreServletsWAR/AppletShowQueryGenerator?useNumbering=true";
	...
	public void init() {
		...
		/**		
				...
				currentQueries = new AppletShowQueryCollection(address, currentPage);
	...
	*/
	...
	private void setUpTableModel() {
		...
		jTable.getTableHeader().addMouseListener(new 
		   MouseAdapter()
		   {  
			  ...
			  {  
				 ...
				 int tableColumn
					= jTable.columnAtPoint(event.getPoint());
		
				 // translate to jTable model index and sort
				 int modelColumn
					= jTable.convertColumnIndexToModel(tableColumn);
	...
	private String[] columnNames =
		{ "String", "Decimal", "Integer", "Boolean", "Color"};
	...
	public void actionPerformed(ActionEvent event) {
		if (event.getSource() == startButton) {
			...
			currentPage = getCodeBase();
			currentQueries =
				new AppletShowQueryCollection(address, currentPage);
			columnNames = new String[]{"A","B","C","D","E","F","J","K","L","M"};
			while (!currentQueries.isDone()) {
				showStatus("Waiting for data from server...");
				pause(1);
			}
