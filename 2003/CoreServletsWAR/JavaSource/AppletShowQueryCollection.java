...
public class AppletShowQueryCollection implements Runnable {
  private Object[][] queries;
  private boolean isDone = false;
  private URL dataURL;

  public AppletShowQueryCollection(String urlSuffix, URL currentPage) {
    try {
  ...
  private Object[][] retrieveQueries() throws IOException {
