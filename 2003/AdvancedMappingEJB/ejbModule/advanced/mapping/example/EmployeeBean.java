...
public abstract class EmployeeBean implements javax.ejb.EntityBean {
	 ...
	 * ejbCreate
	 */
	public advanced.mapping.example.EmployeeKey ejbCreate(java.lang.String ssn)
	 ...
	 */
	public abstract advanced.mapping.example.AddressLocal getAddress();
	/**
	 * This method was generated for supporting the relationship role named address.
	 * It will be deleted/edited when the relationship is deleted/edited.
	 */
	public abstract void setAddress(
		advanced.mapping.example.AddressLocal anAddress);
}
