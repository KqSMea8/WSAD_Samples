 ...
 * stored in a Java .properties file.
 */
public class ApplicationProperties {
    ...
    public static String datasourceJndiName = properties.getString("com.wsbook.servletexample.mapping.datasource.name");
    public static String datasourceSchemaName = properties.getString("com.wsbook.servletexample.mapping.datasource.schemaname");
    public static String datasourceUserId = properties.getString("com.wsbook.servletexample.mapping.datasource.userid");
    public static String datasourcePassword = properties.getString("com.wsbook.servletexample.mapping.datasource.password");
