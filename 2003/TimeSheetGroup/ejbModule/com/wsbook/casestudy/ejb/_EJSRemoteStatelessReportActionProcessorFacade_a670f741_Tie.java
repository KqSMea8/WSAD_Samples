...
public class _EJSRemoteStatelessReportActionProcessorFacade_a670f741_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessReportActionProcessorFacade_a670f741 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.wsbook.casestudy.ejb.ReportActionProcessorFacade:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessReportActionProcessorFacade_a670f741) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 97: 
                    if (method.equals("generateEmployeeByMonthReport")) {
                        return generateEmployeeByMonthReport(in, reply);
                    }
                case 101: 
    ...
    private org.omg.CORBA.portable.OutputStream generateEmployeeByMonthReport(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Report result;
        try {
            result = target.generateEmployeeByMonthReport();
        ...
        out.write_value(result,Report.class);
        return out;
    }
}
