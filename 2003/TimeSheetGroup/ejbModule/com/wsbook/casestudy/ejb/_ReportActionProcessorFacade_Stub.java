...
public class _ReportActionProcessorFacade_Stub extends Stub implements ReportActionProcessorFacade {
    ...
    public Report generateEmployeeByMonthReport() throws ModelException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("generateEmployeeByMonthReport", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Report) in.read_value(Report.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
                    ...
                    return generateEmployeeByMonthReport();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("generateEmployeeByMonthReport",com.wsbook.casestudy.ejb.ReportActionProcessorFacade.class);
            if (so == null) {
                return generateEmployeeByMonthReport();
            }
            try {
                Report result = ((com.wsbook.casestudy.ejb.ReportActionProcessorFacade)so.servant).generateEmployeeByMonthReport();
                return (Report)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
