...
public class _ReportActionProcessorFacadeHome_Stub extends Stub implements ReportActionProcessorFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.wsbook.casestudy.ejb.ReportActionProcessorFacadeHome:0000000000000000", 
    ...
    public ReportActionProcessorFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ReportActionProcessorFacade) in.read_Object(ReportActionProcessorFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.wsbook.casestudy.ejb.ReportActionProcessorFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                ReportActionProcessorFacade result = ((com.wsbook.casestudy.ejb.ReportActionProcessorFacadeHome)so.servant).create();
                return (ReportActionProcessorFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
