...
public class _TimeSheetActionProcessorFacadeHome_Stub extends Stub implements TimeSheetActionProcessorFacadeHome {
    
    private static final String[] _type_ids = {
        "RMI:com.wsbook.casestudy.ejb.TimeSheetActionProcessorFacadeHome:0000000000000000", 
    ...
    public TimeSheetActionProcessorFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TimeSheetActionProcessorFacade) in.read_Object(TimeSheetActionProcessorFacade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.wsbook.casestudy.ejb.TimeSheetActionProcessorFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                TimeSheetActionProcessorFacade result = ((com.wsbook.casestudy.ejb.TimeSheetActionProcessorFacadeHome)so.servant).create();
                return (TimeSheetActionProcessorFacade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
