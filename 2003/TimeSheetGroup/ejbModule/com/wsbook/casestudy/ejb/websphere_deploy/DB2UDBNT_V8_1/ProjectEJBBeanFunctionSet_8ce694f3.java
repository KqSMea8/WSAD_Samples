...
/**
 * ProjectEJBBeanFunctionSet_8ce694f3
 */
public class ProjectEJBBeanFunctionSet_8ce694f3 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	...
	public void Create(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			pstmt = prepareStatement(connection,"INSERT INTO PROJECTEJB (PROJNUMBER, NAME) VALUES (?, ?)");
	...
	public void Remove(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		try {
			pstmt = prepareStatement(connection,"DELETE FROM PROJECTEJB  WHERE PROJNUMBER = ?");
	...
	public void Store(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		try {
			pstmt = prepareStatement(connection,"UPDATE PROJECTEJB  SET NAME = ? WHERE PROJNUMBER = ?");
	...
	public javax.resource.cci.Record FindAll(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			/* select object(o) from ProjectEJB o */
			pstmt = prepareStatement(connection,"select  q1.\"NAME\",  q1.\"PROJNUMBER\" from PROJECTEJB q1");
	...
	public javax.resource.cci.Record FindAllForUpdate(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			/* select object(o) from ProjectEJB o */
			pstmt = prepareStatement(connection,"select  q1.\"NAME\",  q1.\"PROJNUMBER\" from PROJECTEJB q1 for update of \"NAME\"");
	 ...
	 * FindByName
	 */
	public javax.resource.cci.Record FindByName(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select OBJECT(o) from ProjectEJB o where o.name = ?1 */
			pstmt = prepareStatement(connection,"select  q1.\"NAME\",  q1.\"PROJNUMBER\" from PROJECTEJB q1 where  ( q1.\"NAME\" = ?)");
	 ...
	 * FindByNameForUpdate
	 */
	public javax.resource.cci.Record FindByNameForUpdate(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		ResultSet result=null;
		try {
			/* select OBJECT(o) from ProjectEJB o where o.name = ?1 */
			pstmt = prepareStatement(connection,"select  q1.\"NAME\",  q1.\"PROJNUMBER\" from PROJECTEJB q1 where  ( q1.\"NAME\" = ?)  for update of \"NAME\"");
	...
	public javax.resource.cci.Record FindByPrimaryKey(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		ResultSet result=null;
		try {
			pstmt = prepareStatement(connection,"SELECT T1.NAME, T1.PROJNUMBER FROM PROJECTEJB  T1 WHERE T1.PROJNUMBER = ?");
	...
	public javax.resource.cci.Record FindByPrimaryKey444Update(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		ResultSet result=null;
		try {
			pstmt = prepareStatement(connection,"SELECT T1.NAME, T1.PROJNUMBER FROM PROJECTEJB  T1 WHERE T1.PROJNUMBER = ? FOR UPDATE  OF NAME");
	 ...
	 * ProjectEJBBeanFunctionSet_8ce694f3
	 */
	public ProjectEJBBeanFunctionSet_8ce694f3() {
		...
		functionHash.put("FindByName",new Integer(6));
		functionHash.put("FindByNameForUpdate",new Integer(7));
	...
	public Record execute(WSInteractionSpec interactionSpec, IndexedRecord inputRecord, Object connection) throws javax.resource.ResourceException {
		...
		case 6:
			...
			break;
		case 7:
			outputRecord=FindByNameForUpdate(inputRecord,connection,interactionSpec);
			break;
		case 8:
