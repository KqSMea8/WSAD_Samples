 ...
 */
public void testFindProject() throws MappingException {
	Project deptKey = new Project();
	deptKey.setNumber("P1");
	Mapper mapper = deptKey.getMapper();
	assertNotNull("Can't retrieve Mapper for TestArea", mapper);
	
	Project retrievedDept = (Project)mapper.findByPrimaryKey(deptKey);
